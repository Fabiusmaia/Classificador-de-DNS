        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 mb-2">
                    ...
                    <ul>
                        <li class="text-white dark:text-white">Seguro: {{ $percentSafe }}%</li>
                        <li class="text-white dark:text-white">Suspeito: {{ $percentSuspicious }}%</li>
                        <li class="text-white dark:text-white">Malicioso: {{ $percentMalicious }}%</li>
                    </ul>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <ol class="list-decimal list-inside">
                        ...
                        <li class="text-white dark:text-white">{{ $log->domain }} ({{ $log->queried_at->format('Y-m-d H:i') }})</li>
                        @endforeach
                    </ol>
                </div>
            </div>
